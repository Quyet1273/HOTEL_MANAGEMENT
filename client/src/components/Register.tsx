  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden">
      ...
      {backgroundImages.map((image, index) => (
        ...
        >
          <div className="absolute inset-0 bg-linear-to-br from-purple-900/80 via-purple-800/70 to-blue-900/80"></div>
        </div>
      ))}
      ...
      <div className="relative w-full max-w-2xl z-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-linear-to-r from-purple-600 to-purple-700 text-white rounded-xl hover:from-purple-700 hover:to-purple-800 shadow-lg shadow-purple-600/30 transition-all duration-200 hover:shadow-xl hover:scale-[1.02] font-medium"
            >
              Đăng ký
            </button>
          </form>
