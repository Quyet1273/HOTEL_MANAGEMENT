...
import { User, Mail, Phone, MapPin, Camera, Save, Edit,  } from 'lucide-react'; // upload
...
interface ProfileProps {
  ...
  onUpdateUser: (user: { name: string; email: string; avatar: string; role: "admin" | "manager" | "receptionist" | "housekeeping" }) => void;
}
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="bg-white rounded-2xl border border-gray-200/50 shadow-sm overflow-hidden">
        {/* Cover Image */}
        <div className="h-32 bg-linear-to-r from-blue-400 to-cyan-300 relative">
          ...
          <div className="flex items-start gap-6 -mt-16 relative">
            ...
            <div className="relative group">
              {currentAvatar ? (
                ...
                <div className="w-32 h-32 bg-linear-to-br from-blue-600 to-blue-700 rounded-2xl flex items-center justify-center text-white border-4 border-white shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {isEditing && (
                <div className="flex gap-3 pt-4">
                  <button
                    type="submit"
                    className="flex items-center gap-2 px-6 py-3 bg-linear-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 shadow-lg shadow-blue-600/30 transition-all duration-200 hover:shadow-xl font-medium"
                  >
